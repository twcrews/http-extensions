...
### Changed
- **Breaking Change**: Refactor `QueryString.Parameter` to a `record class` with constructors for cleaner instantiation.
- Update project target to .NET Standard 2.0 for maximum compatibility.
- Upgrade `Crews.Extensions.Primitives` dependency to version 1.2.1.
...
[3.0.0]: https://github.com/twcrews/http-extensions/compare/2.0.0...3.0.0
