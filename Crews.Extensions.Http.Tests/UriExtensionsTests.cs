...
public class UriExtensionsTests
{
	...
	[Theory(DisplayName = "EnsureTrailingSlash correctly appends one trailing slash to a URI")]
	[InlineData("http://a.bc")]
	[InlineData("http://a.bc/")]
	[InlineData("http://a.bc////")]
	public void EnsureTrailingSlash_CorrectlyAppendsSlash(string uriString)
	{
		Uri expected = new("http://a.bc/");
		Uri subject = new(uriString);
		Uri actual = subject.EnsureTrailingSlash();
